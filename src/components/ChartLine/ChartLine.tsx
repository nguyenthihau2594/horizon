...
import { ReactComponent as IconCalendarLight } from 'assets/img/icons/icon_calendar_light.svg';
  ...
  return (
    <div className={s.chart_line}>
      <div className={s.statistic}>
        <button type="button" className={s.btn_calendar}>{context.theme === 'light' ? <IconCalendarLight /> : <IconCalendar />}This month</button>
